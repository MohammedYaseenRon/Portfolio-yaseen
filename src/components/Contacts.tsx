  ...
  return (
    <section id="contacts" className="py-12 md:py-16 bg-[#0A0A0A]">
      <div className="max-w-5xl mx-auto px-4">
        <div
          ref={ref}
          className={`relative z-10 transition-opacity duration-700 ${isInView ? "opacity-100" : "opacity-0"}`}
        >
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            {/* Contact Information */}
            <div
              className={`flex flex-col justify-between transition-all duration-500 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            ...
            >
              <div className="p-8 rounded-lg bg-gray-800/20 border border-gray-700 shadow-xl mb-8">
                ...
                <div className="space-y-6">
                  {contactInfo.map((item, index) => (
                    <a key={index} href={item.href} className="flex items-start group">
                      <div className="bg-gray-700 p-3 rounded-lg mr-4 text-teal-200 group-hover:bg-teal/20 transition-colors">
                        <item.icon size={20} />
                      </div>
                      <div>
                        <h4 className="font-semibold text-white">{item.title}</h4>
                        <p className="text-gray-300 group-hover:text-teal transition-colors">{item.content}</p>
                      </div>
                    </a>
                  ))}
                </div>
              ...
              <div className="p-8 rounded-lg bg-gray-800/80 border border-gray-700 shadow-xl">
                ...
                <p className="text-gray-300 mb-6">Follow me on social media to see my latest projects and updates.</p>
